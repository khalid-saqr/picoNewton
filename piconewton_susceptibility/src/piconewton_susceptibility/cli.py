...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Step 3 parent-model continuity")
    ...
    parser.add_argument(
        "--development-skip-step2",
        action="store_true",
        help="Software diagnostics only; cannot produce a passing Step 3 gate.",
    )
